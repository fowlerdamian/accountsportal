  ...
  return (
    <div style={{ flex: 1, overflowY: 'auto', padding: '32px 24px', maxWidth: '1200px', margin: '0 auto', width: '100%', boxSizing: 'border-box' }}>
      ...
      <div style={{ marginBottom: '24px' }}>
        <h1 style={{ fontSize: '18px', fontWeight: 600, color: '#E5E5E5', margin: 0 }}>Invoices</h1>
        <p style={{ fontSize: '13px', color: '#555', margin: '4px 0 0', fontFamily: '"JetBrains Mono", monospace' }}>All carrier freight invoices</p>
      </div>
            ...
            {filtered.map(inv => {
              ...
              return (
                ...
                >
                  ...
                  <td style={{ padding: '11px 14px', fontSize: '12px', fontFamily: '"JetBrains Mono", monospace', color: '#555' }}>{inv.due_date ? new Date(inv.due_date).toLocaleDateString('en-AU') : '—'}</td>
