...
const tabs = [
  ...
  { label: 'Tracking Lookup', to: '/logistics/tracking', end: false },
]
  ...
  return (
    ...
    >
      ...
      <NavLink
        ...
        style={{
          marginLeft: 'auto',
          color: pathname.startsWith('/logistics/settings') ? 'var(--brand-accent)' : 'var(--text-tertiary)',
          borderBottomColor: pathname.startsWith('/logistics/settings') ? 'var(--brand-accent)' : 'transparent',
          background: pathname.startsWith('/logistics/settings') ? 'rgba(var(--brand-accent-rgb),0.04)' : 'transparent',
          textDecoration: 'none',
        }}
      >
